...
- update_held_thread — when the shape of what you're holding for the person changes (something opens,
  ...
  having to manage it. When a held thing has a real deadline or window, set due_at. When it's stalled on
  something specific — a person's signature, another party's response, a waiting period — set blocked_on.
  This is what lets you actually track the shape of the problem over time, not just a flat checklist.
